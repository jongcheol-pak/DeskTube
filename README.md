...
- **차트형 항목 목록**: 항목마다 순위·썸네일·제목·채널명을 표시(유튜브 oEmbed 자동 조회·로컬 캐시, 실패 시 URL 표시), 셔플듣기·전체듣기 버튼과 행별 "이 곡부터 듣기" 재생, 우클릭 공유(URL 확인·클립보드 복사 팝업) 지원, 지금 재생 중인 곡은 순위 자리에 코럴 스피커 아이콘으로 표시(곡 전환 시 이동·일시정지 중 유지) (FR-18)
